...
fun main(){
    ...
    val employee=Employee(1,"Nayely Garcia Ramirez",
        AcademicLevel.BACHELOR,"GARN000506MOCRMYA4",
        LocalDate.parse("2009-08-05"),"001")
    ...
    val checkInOut = listOf(
        ...
        CheckInOut(LocalDate.parse("2022-09-12"),employee, LocalTime.of(8,11),LocalTime.of(14,0)),
